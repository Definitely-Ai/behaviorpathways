        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-bold text-xl text-gray-900">Behavior Pathways</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/approach" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">
                  Our Approach
                </Link>
              </li>
              <li>
                <Link href="/parent-training" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">
                  Parent Training
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/resources" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">
                  Resource Library
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex flex-wrap justify-center sm:justify-end gap-4 sm:gap-6 text-sm">
              ...
              <Link href="/accessibility" className="text-gray-600 hover:text-blue-600 transition-colors duration-300">
                Accessibility
              </Link>
            </div>
          </div>
